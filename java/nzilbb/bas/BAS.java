 ...
 * <pre>
 * BAS bas = new BAS();
 * {@link BASResponse} response = bas.MAUSBasic("eng-NZ", new File("recording.wav"), new File("transcript.txt"));
 ...
 * }
 * </pre>
 * <p>Input files can be supplied using an InputStream or a File.  In some cases, a String can also be used as input.
...
public class BAS
{
   ...
   /**
    * URL for the MAUSBasic service - default: https://clarin.phonetik.uni-muenchen.de/BASWebServices/services/runMAUSBasic
    * @see #getMAUSBasicUrl()
   ...
   /**
    * Getter for {@link #MAUSBasicUrl}: URL for the MAUSBasic service - default: https://clarin.phonetik.uni-muenchen.de/BASWebServices/services/runMAUSBasic
   ...
   /**
    * URL for the G2P service - default: http://clarin.phonetik.uni-muenchen.de/BASWebServices/services/runG2P
    * @see #getG2PUrl()
    * @see #setG2PUrl(String)
    */
   protected String G2PUrl = "http://clarin.phonetik.uni-muenchen.de/BASWebServices/services/runG2P";
   /**
    * Getter for {@link #G2PUrl}: URL for the G2P service - default: http://clarin.phonetik.uni-muenchen.de/BASWebServices/services/runG2P
   ...
   /**
    * URL for the MAUS service - default: https://clarin.phonetik.uni-muenchen.de/BASWebServices/services/runMAUS
    * @see #getMAUSUrl()
    * @see #setMAUSUrl(String)
    */
   protected String MAUSUrl = "https://clarin.phonetik.uni-muenchen.de/BASWebServices/services/runMAUS";
   /**
    * Getter for {@link #MAUSUrl}: URL for the MAUS service - default: https://clarin.phonetik.uni-muenchen.de/BASWebServices/services/runMAUS
   ...
   /**
    * URL from the Pho2Syl service - default: http://clarin.phonetik.uni-muenchen.de/BASWebServices/services/runPho2Syl
    * @see #getPho2SylUrl()
   ...
   /**
    * Getter for {@link #Pho2SylUrl}: URL from the Pho2Syl service - default: http://clarin.phonetik.uni-muenchen.de/BASWebServices/services/runPho2Syl
   ...
   /**
    * URL for MaryTTS service - default: https://clarin.phonetik.uni-muenchen.de/BASWebServices/services/runTTSFile
    * @see #getTTSUrl()
   ...
   /**
    * URL for the TextAlign service - default: http://clarin.phonetik.uni-muenchen.de/BASWebServices/services/runTextAlign
    * @see #getTextAlignUrl()
   ...
   /**
    * Getter for {@link #TextAlignUrl}: URL for the TextAlign service - default: http://clarin.phonetik.uni-muenchen.de/BASWebServices/services/runTextAlign
    ...
    * @throws ParserConfigurationException If the XML parser for parsing the response could not be configured.
    */
   public BASResponse MAUS(String LANGUAGE, File SIGNAL, File BPF, String OUTFORMAT, String OUTSYMBOL)
    throws IOException, ParserConfigurationException
   {
    ...
    * @throws ParserConfigurationException If the XML parser for parsing the response could not be configured.
    */
   public BASResponse Pho2Syl(String lng, File i, String tier, Boolean wsync, String oform, Integer rate)
    throws IOException, ParserConfigurationException
   {
    ...
    * @throws ParserConfigurationException If the XML parser for parsing the response could not be configured.
    */
   public BASResponse TTS(String INPUT_TYPE, String INPUT_TEXT, String OUTPUT_TYPE, String AUDIO, String VOICE)
    throws IOException, ParserConfigurationException
   {
    ...
    * @throws ParserConfigurationException If the XML parser for parsing the response could not be configured.
    */
   public BASResponse TTS(String INPUT_TYPE, File INPUT_TEXT, String OUTPUT_TYPE, String AUDIO, String VOICE)
    throws IOException, ParserConfigurationException
   {
    ...
    * @throws ParserConfigurationException If the XML parser for parsing the response could not be configured.
    */
   public BASResponse TTS(String INPUT_TYPE, InputStream INPUT_TEXT, String OUTPUT_TYPE, String AUDIO, String VOICE)
    throws IOException, ParserConfigurationException
   {
   ...
   /**
    * Convenience method to invoke the TextAlign service for aligning two representations of text, e.g. letters in orthographic transcript with phonemes in a phonemic transcription, using no cost file, and default options for <div>displc</div> and <div>dir</div>.
    ...
    throws IOException, ParserConfigurationException
   {
	 ...
	 .addTextBody("atype", atype);
      if (costfile != null) builder.addBinaryBody("costfile", costfile, ContentType.create("text/csv"), "BAS.cst.csv");
      HttpEntity entity = builder.build();
      request.setEntity(entity);
      HttpResponse httpResponse = httpclient.execute(request);
      HttpEntity result = httpResponse.getEntity();
