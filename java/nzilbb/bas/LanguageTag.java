...
public class LanguageTag
{
    ...
    * @return An RFC 5646 code with a three-letter primary language code, or the given tag if normalization was not possible.
    */
   public String tag(String language)
   {
	 ...
	 code = language.substring(0, hyphen);
      ...
      if (!iso639Map2ToName.containsKey(code))
