 ...
 * <p> Assuming you've called a BAS method, something like <br>
 *  <code>BASResponse response = new BAS().MAUSBasic(language, signal, text);</code>
 * <ul>
...
public class BASResponse {
   ...
   */
  public void setDownloadLink(String newDownloadLink) throws MalformedURLException { 
   ...
   */
  public BASResponse(InputStream stream) throws ParserConfigurationException, IOException {
   ...
   * @return A temporary file (which the caller has the responsibility to delete), or null
   * if content couldn't be downloaded. 
   * @throws IOException If an IO error occurs.
   */
  public File saveDownload() throws IOException {
   ...
   * @throws IOException If there's an IO error.
   */
  protected void loadXml(InputStream stream) throws IOException {
   ...
   * @throws IOException If an IO error occurs.
   */
  public File saveDownload(File file) throws IOException {
    if (getDownloadLink() == null) return null;
  ...
  /**
   * Tidies up the given string - e.g. replaces series' of whitespaces characters with a
   * single space. 
